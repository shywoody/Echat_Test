 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `EchatModel` protocol for custom methods.
 ...
 ********************** json convertor *********************
 @code
 @interface EchatAuthor : NSObject
 @property (nonatomic, strong) NSString *name;
 @property (nonatomic, assign) NSDate *birthday;
 @end
 @implementation EchatAuthor
 @end
 
 @interface EchatBook : NSObject
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) NSUInteger pages;
 @property (nonatomic, strong) EchatAuthor *author;
 @end
 @implementation EchatBook
 @end
 
 int main() {
 // create model from json
 EchatBook *book = [EchatBook Echat_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
 // convert model to json
 NSString *json = [book Echat_modelToJSONString];
 ...
 ********************** Coding/Copying/hash/equal *********************
 @code
 @interface EchatShadow :NSObject <NSCoding, NSCopying>
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) CGSize size;
 @end
 
 @implementation EchatShadow
 - (void)encodeWithCoder:(NSCoder *)aCoder { [self Echat_modelEncodeWithCoder:aCoder]; }
 - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self Echat_modelInitWithCoder:aDecoder]; }
 - (id)copyWithZone:(NSZone *)zone { return [self Echat_modelCopy]; }
 - (NSUInteger)hash { return [self Echat_modelHash]; }
 - (BOOL)isEqual:(id)object { return [self Echat_modelIsEqual:object]; }
 @end
 @endcode
 
 */
@interface NSObject (EchatModel)
 ...
 */
+ (nullable instancetype)Echat_modelWithJSON:(id)json;
...
/**
 ...
 `NSString` -> NSDate, parsed with format "EchatEchat-MM-dd'T'HH:mm:ssZ", "EchatEchat-MM-dd HH:mm:ss" or "EchatEchat-MM-dd".
 `NSString` -> NSURL.
 `NSValue` -> struct or union, such as CGRect, CGSize, ...
 `NSString` -> SEL, Class.
 */
+ (nullable instancetype)Echat_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)Echat_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)Echat_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)Echat_modelToJSONObject;
 ...
 */
- (nullable NSData *)Echat_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)Echat_modelToJSONString;
 ...
 */
- (void)Echat_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)Echat_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)Echat_modelIsEqual:(id)model;
 ...
 */
- (NSString *)Echat_modelDescription;
 ...
 */
+ (nullable NSArray *)Echat_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (EchatModel)
 ...
 */
+ (nullable NSDictionary *)Echat_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<EchatModel>' to your class header.
 */
@protocol EchatModel <NSObject>
@optional
...
/**
 ...
 Example:
 @code
 @class EchatShadow, EchatBorder, EchatAttachment;
 
 @interface EchatAttributes
 @property NSString *name;
 ...
 @implementation EchatAttributes
 + (NSDictionary *)modelContainerPropertyGenericClass {
 return @{@"shadows" : [EchatShadow class],
 @"borders" : EchatBorder.class,
 @"attachments" : @"EchatAttachment" };
 }
 @end
 @endcode
...
/**
 ...
 Example:
 @code
 @class EchatCircle, EchatRectangle, EchatLine;
 
 @implementation EchatShape
 
 + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
 if (dictionary[@"radius"] != nil) {
 return [EchatCircle class];
 } else if (dictionary[@"width"] != nil) {
 return [EchatRectangle class];
 } else if (dictionary[@"y2"] != nil) {
 return [EchatLine class];
 } else {
 return [self class];
 }
 }
