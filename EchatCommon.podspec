...
仅仅是个测试123123123132
  ...
  s.author             = { "xielang" => "beatdoudou@163.com" }
  # Or just: s.author    = "xielang"
  # s.authors            = { "xielang" => "beatdoudou@163.com" }
  # s.social_media_url   = "http://twitter.com/xielang"
...
# s.preserve_paths = "FilesToSave", "MoreFilesToSave"
  ...
  s.libraries = "stdc__.tbd", "z.tbd","c++.tbd","icucore.tbd"
  # s.library   = "iconv"
